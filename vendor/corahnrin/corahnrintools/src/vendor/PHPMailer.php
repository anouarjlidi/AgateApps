...
class PHPMailer {
	...
	*/
	...
	function SetLanguage($langcode = 'en', $lang_path = 'language/') {
		$lang_path = ROOT.DS.'configs'.DS.'mailer'.DS;//Assure que le chemin des langues est bien spécifié
		...
		$PHPMAILER_LANG = array(
				...
				'variable_set'         => 'Cannot set or reset variable: '
						...
						$l = true;
						if ($langcode != 'en' && file_exists($lang_path.'phpmailer.lang-'.$langcode.'.php')) { //There is no English translation file
