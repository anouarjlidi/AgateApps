...
//	$nbreqtemp+=2;
	...
	$q = $new->prepare($sql);
    $q->execute(array ( 'id' => '1', 'name' => '<h2>Administration</h2>', 'position' => '0', 'created' => '2014-01-31 18:18:28', 'updated' => '2014-01-31 18:18:28', 'deleted' => '0', 'parent_id' => NULL, 'route' => NULL, 'roles' => 'a:2:{i:0;s:9:"ROLE_USER";i:1;s:12:"ROLE_MANAGER";}', ));$nbreq++;$nbreqtemp++;
    ...
    $q->execute(array ( 'id' => '15', 'name' => 'Traductions', 'position' => '3', 'created' => '2014-01-31 19:24:16', 'updated' => '2014-01-31 21:42:05', 'deleted' => '13', 'parent_id' => NULL, 'route' => NULL, 'roles' => 'a:0:{}', ));$nbreq++;$nbreqtemp++;
