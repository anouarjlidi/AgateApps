...
class RoutesFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    function load(ObjectManager $manager)
    {
        ...
        foreach ($routes as $route) {
            ...
            $this->fixtureObject($repo, $route['id'], $$map, $faction ? $$faction : null, $route['name'], $route['coordinates'], $$markerStart, $$markerEnd, $$routeType);
        }

        $this->manager->flush();
    }

    public function fixtureObject(EntityRepository $repo, $id, $map, $faction, $name, $latLngs, $markerStart, $markerEnd, $routeType)
    {
        $obj       = null;
        $newObject = false;
        $addRef    = false;
