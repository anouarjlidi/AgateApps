...
class FactionsFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    function load(ObjectManager $manager)
    {
        ...
        $this->fixtureObject($repo, 1, $book1, 'Temple', 'Les adeptes de la religion du Temple.');
        ...
        $this->fixtureObject($repo, 5, $book1, 'Osags', 'Rattachés au culte Démorthèn, les Osags en sont peut être l\'expression la plus radicale.');
        ...
        $this->fixtureObject($repo, 13, $book1, 'Chevaliers Ronce', 'Les individus qui dominent sont en rupture avec la société, pour des raisons d\'intérêt ou d\'opinion. Le territoire est une zone grise, où la violence est endémique.');
