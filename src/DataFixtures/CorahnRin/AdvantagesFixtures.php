...
class AdvantagesFixtures extends AbstractFixture implements OrderedFixtureInterface, ORMFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->fixtureObject($repo, 13, null, 'Endurant', 'Endurante', 30, '+1 au score de Vigueur et aux jets de Prouesses concernant l\'endurance', 1, ['vig', Domains::FEATS['title']], 0, 0, $book);
        ...
        $this->fixtureObject($repo, 17, null, 'Leste', 'Leste', 40, '+1 au score de Défense, et aux jets de Discrétion et de Prouesses concernant l\'agilité', 1, ['def', Domains::STEALTH['title'], Domains::FEATS['title']], 0, 0, $book);
