...
class TranslationAdmin extends Admin {
    ...
    protected function configureFormFields(FormMapper $formMapper) {
        ...
        $help = $this->getConfigurationPool()->getContainer()->get('templating')->render('PierstovalTranslationBundle:Translate:translations_like_help.html.twig', array('translations' => $likes));
