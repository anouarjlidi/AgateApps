...
namespace CorahnRin\TranslationBundle\Command;
...
class TranslationExportCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('corahnrin:translation:export')
            ->setDefinition(array(
...
EOF
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $repo = $this->getContainer()->get('doctrine')->getManager()->getRepository('CorahnRinTranslationBundle:Translation');
