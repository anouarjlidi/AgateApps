...
//        $domain14 = $this->getReference('corahnrin-domain-14');
        ...
        $this->fixtureObject($repo, 5, [$domain2, $domain11, $domain13, $domain16], 'Noblesse', 'Vous portez peut-être un grand nom des affaires des grandes cités, ou avez grandi en ville. Néanmoins, votre famille est placée assez haut dans la noblesse pour vous permettre d\'avoir eu des enseignements particuliers.', '2014-04-09 08:56:43', '2014-04-09 08:56:43', null);
