...
class Money {
	...
	/**
	 * Retourne la liste des noms de monnaies, ou un nom litéral si un index est fourni
	...
	/**
	 * Génère des getters et setters dynamiques sans avoir à les créer directement dans l'objet.
	 * @param string $name Nom de la méthode dynamique
	 * @param array $arguments Arguments envoyés à la méthode dynamique
	 * @return \CorahnRin\CharactersBundle\Classes\Money|null|number
	 */
