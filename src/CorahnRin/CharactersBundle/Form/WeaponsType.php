...
class WeaponsType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('price', 'integer', array('label'=>'Prix','attr'=>array('placeholder'=>'Prix (en daols de Braise)','data-toggle'=>'tooltip','title'=>'Prix (en daols de Braise)', 'data-placement'=>'left')))
            ...
            ->add('range', null, array('label'=>'Portée','required'=>false,
                'attr'=>array('placeholder'=>$desc,'title'=>$desc,'data-toggle'=>'tooltip','data-placement'=>'left')))
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'CorahnRin\CharactersBundle\Entity\Weapons'
        ));
    }
