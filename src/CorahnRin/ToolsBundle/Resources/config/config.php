...
$dirtools = dirname(__FILE__);
$corahn_rin_dir = str_replace('Resources'.DIRECTORY_SEPARATOR.'config', '', $dirtools);
define('CORAHNRIN', true);
//define('CORAHNRIN_TOOLS', CORAHNRIN.DS.'ToolsBundle');
...
define('P_FPDF_FONTPATH',			__DIR__.'..'.DS.'fpdf'.DS.'fonts');
define('P_FPDF_SYSTEM_TTF_FONTS',	__DIR__.'..'.DS.'fpdf'.DS.'fonts');
...
$versions_xml = file_get_contents(__DIR__.DS.'versions.xml');
