...
use CorahnRin\MapsBundle\Entity\RoutesTypes;
use CorahnRin\MapsBundle\Form\RoutesType;
use CorahnRin\MapsBundle\Form\RoutesTypesType;
...
class RoutesController extends Controller {
    ...
    public function adminListAction() {
        return array(
            'routes' => $this->getDoctrine()->getManager()->getRepository('CorahnRinMapsBundle:Routes')->findAll(),
            'routesTypes' => $this->getDoctrine()->getManager()->getRepository('CorahnRinMapsBundle:RoutesTypes')->findAll()
        );
    }
    ...
    public function addAction() {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('corahnrin_maps_routes_adminlist'));
        }
        ...
        return array(
            ...
            'breadcrumbs' => array(
                ...
                'Routes' => array('route'=>'corahnrin_maps_routes_adminlist'),
            ),
        );
    }
    ...
    public function addTypeAction() {
        $routeType = new \CorahnRin\MapsBundle\Entity\RoutesTypes;
